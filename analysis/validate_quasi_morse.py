...
Usage:
  python validate_quasi_morse.py --dim 10 --func all --base experiments --outdir out --plots

  python validate_quasi_morse.py.py --dim 10 --func f1,f3,f5,f11 --base experiments \\
