...
if __name__ == "__main__":
    ...
    if pkl_100k.exists() and pkl_1M.exists():
        ...
        print("=" * 100)
        print("""
The ratio a_valid / p_cens measures how well a constant-hazard model fits the data:

  - Clustered (a/p < 0.3): Hits arrive in bursts after warm-up.
    The constant-hazard bound is conservative by factor 3-25×.
    
  - Moderate (0.3 ≤ a/p < 0.7): Intermediate behavior.
  
  - Geometric (a/p ≥ 0.7): Hits spread out, approximately constant hazard.
    The exponential tail bound is nearly tight.

Key findings:
  - Unimodal functions (F1-F4): strongly clustered hitting
  - Multimodal functions (F11-F15): moderate to geometric
  - Composition functions (F21-F30): intractable (0 hits even at 1M evals)
""")
