...
class LSHADE:
    ...
    def _log_state(self, pop, fit, all_F, all_CR, successful_f, successful_cr, delta_f):
    ...
    def _lshade_generation(self, pop, fit):
        ...
        self._log_state(new_pop, new_fit, all_F, all_CR, successful_f, successful_cr, delta_f)
